...
var imagemArco, imagemFlecha, imagem_balaoVerde, imagem_balaoVermelho, imagem_balaoRosa ,imagem_balaoAzul, imagemPlanoFundo,gFlecha,gVermelho,gVerde,gAzul,gRosa;
var placar = 0;
...
function draw() {
 background(0);
  ...
  if(gFlecha.isTouching(gVermelho)){
    gVermelho.destroyEach();
    gFlecha.destroyEach();
    placar=placar+1;
  }
  
  if(gFlecha.isTouching(gAzul)){
    gAzul.destroyEach();
    gFlecha.destroyEach();
    placar=placar+2;
  }
  
  if(gFlecha.isTouching(gVerde)){
    gVerde.destroyEach();
    gFlecha.destroyEach();
    placar=placar+3;
  }
  
  if(gFlecha.isTouching(gRosa)){
    gRosa.destroyEach();
    gFlecha.destroyEach();
    placar=placar+4;
  }
  
text("placar: "+placar, 300,60);    
